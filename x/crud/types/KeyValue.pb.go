...
type KeysUnderUuid struct {
	Uuid string   `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`
	Keys []string `protobuf:"bytes,2,rep,name=keys,proto3" json:"keys,omitempty"`
}

func (m *KeysUnderUuid) Reset()         { *m = KeysUnderUuid{} }
func (m *KeysUnderUuid) String() string { return proto.CompactTextString(m) }
func (*KeysUnderUuid) ProtoMessage()    {}
func (*KeysUnderUuid) Descriptor() ([]byte, []int) {
	return fileDescriptor_4383c9ff602ab966, []int{3}
}
func (m *KeysUnderUuid) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *KeysUnderUuid) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_KeysUnderUuid.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *KeysUnderUuid) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KeysUnderUuid.Merge(m, src)
}
func (m *KeysUnderUuid) XXX_Size() int {
	return m.Size()
}
func (m *KeysUnderUuid) XXX_DiscardUnknown() {
	xxx_messageInfo_KeysUnderUuid.DiscardUnknown(m)
}

var xxx_messageInfo_KeysUnderUuid proto.InternalMessageInfo

func (m *KeysUnderUuid) GetUuid() string {
	if m != nil {
		return m.Uuid
	}
	return ""
...
func (m *KeysUnderUuid) GetKeys() []string {
	if m != nil {
		return m.Keys
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*KeysUnderUuid)(nil), "bluzelle.curium.crud.KeysUnderUuid")
}
...
var fileDescriptor_4383c9ff602ab966 = []byte{
	...
	0xac, 0xcc, 0x29, 0x27, 0x3f, 0x39, 0xbb, 0x18, 0x6c, 0x19, 0x73, 0x10, 0xb2, 0x90, 0x92, 0x39,
	0xd8, 0xad, 0xc5, 0xa1, 0x79, 0x29, 0xa9, 0x45, 0xa1, 0xa5, 0x99, 0x29, 0x42, 0x42, 0x5c, 0x2c,
	0xa5, 0xa5, 0x99, 0x29, 0x50, 0x53, 0xc0, 0x6c, 0x90, 0x58, 0x76, 0x6a, 0x25, 0x48, 0x3f, 0x33,
	0x48, 0x0c, 0xc4, 0x76, 0x72, 0x3c, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f,
	0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39, 0x86, 0x28,
	0xf5, 0xf4, 0xcc, 0x92, 0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x98, 0x07, 0xf4, 0x21,
	0x1e, 0xd0, 0xaf, 0xd0, 0x07, 0x87, 0x70, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0x38, 0x88,
	0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xe2, 0x1c, 0x16, 0xf3, 0xa1, 0x01, 0x00, 0x00,
}
...
func (m *KeysUnderUuid) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *KeysUnderUuid) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *KeysUnderUuid) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Keys) > 0 {
		for iNdEx := len(m.Keys) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintKeyValue(dAtA, i, uint64(len(m.Keys[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.Uuid) > 0 {
		i -= len(m.Uuid)
		copy(dAtA[i:], m.Uuid)
		i = encodeVarintKeyValue(dAtA, i, uint64(len(m.Uuid)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *KeysUnderUuid) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *KeysUnderUuid) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KeysUnderUuid: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KeysUnderUuid: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
