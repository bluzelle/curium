...
func (m *QuerySearchResponse) GetSearchString() string {
	if m != nil {
...
func (m *PagingRequest) GetStartKey() string {
	if m != nil {
		return m.StartKey
	}
	return ""
...
func (m *PagingRequest) GetLimit() uint64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *PagingResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PagingResponse.Merge(m, src)
}
...
func (m *PagingResponse) GetNextKey() string {
	if m != nil {
		return m.NextKey
	}
	return ""
...
func (m *PagingResponse) GetTotal() uint64 {
	if m != nil {
		return m.Total
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*PagingRequest)(nil), "bluzelle.curium.crud.PagingRequest")
	proto.RegisterType((*PagingResponse)(nil), "bluzelle.curium.crud.PagingResponse")
}
...
var fileDescriptor_766d4a8cfa5b40b7 = []byte{
	...
	,
}
...
func (m *PagingRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PagingRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PagingRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.StartKey) > 0 {
		...
		i = encodeVarintQuery(dAtA, i, uint64(len(m.StartKey)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *PagingResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PagingResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PagingResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PagingRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PagingResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PagingRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PagingRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PagingRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *PagingResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PagingResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PagingResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
