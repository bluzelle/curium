...
2.  Make sure your Environment paths are set in your .profile file, for example, add the following to the end:
    ...
    GOPATH is where the golang project source files, packages and binaries are kept. Make sure that the go compiler is in the PATH

3.  Make the golang working folders
